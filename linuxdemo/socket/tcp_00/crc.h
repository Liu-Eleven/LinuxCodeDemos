...
inline void RecoverSelfData(unsigned char* pData, int Len)
{
...
inline void SwitchHighLow(unsigned char* pData, int Len)
{
    unsigned char i,j;
    unsigned char Temp;
...
inline unsigned short crc16(unsigned char *pbuf, int len)
{
...
inline unsigned char package_check(unsigned char *inBuf, short bufLen)
{
...
inline void print_hex(unsigned char* data, int len)
{
	int i = 0;
	for(i=0; i<len; i++)
	{
